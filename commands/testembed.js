...
exports.run = async (bot,message,args) => {
    ...
    .setAuthor('KnightleyBot', 'https://imgur.com/a/CIgE4sC', 'https://discord.com/api/oauth2/authorize?client_id=824018254812282881&permissions=0&scope=bot')
    ...
    .setTimestamp()
    .setFooter('...Horace Knightley.', 'https://imgur.com/a/CIgE4sC');
